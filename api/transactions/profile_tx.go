...
func (store *SQLStore) UpdateProfileTx(ctx context.Context, publicID uuid.UUID, bio string, avatarUrl string, fullName, city, state, country string, latitude, longitude float64) (models.UserProfiles, error) {
