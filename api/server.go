...
func NewServer(config util.Config, store *db.Store) (*Server, error) {
	...
	authRouter.GET("/getClubMember", server.getClubMember)
	...
	authRouter.POST("/addFootballMatchScore", server.addFootballMatchScore)
	authRouter.GET("/getFootballMatchScore", server.getFootballMatchScore)
	...
	authRouter.PUT("/updateMatchScheduleTime", server.updateMatchScheduleTime)
	authRouter.PUT("/updateFootballMatchScore", server.updateFootballMatchScore)
	authRouter.PUT("/updateTournamentStanding", server.updateTournamentStanding)
	authRouter.POST("/addCricketMatchScore", server.addCricketMatchScore)
	authRouter.GET("/getCricketMatchScore", server.getCricketMatchScore)
	authRouter.PUT("/updateCricketMatchRunsScore", server.updateCricketMatchRunsScore)
	authRouter.PUT("/updateCricketMatchWicket", server.updateCricketMatchWicket)
	authRouter.PUT("/updateCricketMatchExtras", server.updateCricketMatchExtras)
	authRouter.PUT("/updateCricketMatchInnings", server.updateCricketMatchInnings)
	authRouter.POST("/addCricketTeamPlayerScore", server.addCricketTeamPlayerScore)
	authRouter.GET("/getCricketTeamPlayerScore", server.getCricketTeamPlayerScore)
	authRouter.GET("/getCricketPlayerScore", server.getCricketPlayerScore)
	authRouter.PUT("/updateCricketMatchScoreBatting", server.updateCricketMatchScoreBatting)
	authRouter.PUT("/updateCricketMatchScoreBowling", server.updateCricketMatchScoreBowling)
	authRouter.POST("/addFootballGoalByPlayer", server.addFootballGoalByPlayer)
	authRouter.POST("/addCricketMatchToss", server.addCricketMatchToss)
	authRouter.GET("/getMatch", server.getMatch)
	authRouter.GET("/getCricketMatchToss", server.getCricketMatchToss)
